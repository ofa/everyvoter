    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('online_vr_deadline', models.DateField(blank=True, help_text=b'The explicit deadline by which voters in the state must register to vote online in order to vote', null=True, verbose_name=b'Online Voter Registration Deadline')),
                ...
                ('ballot_return_date', models.DateField(help_text=b'The date by which voters must return their mailed ballots', verbose_name=b'Vote By Mail Ballot Return Date')),
            ],
            options={
                'abstract': False,
            },
