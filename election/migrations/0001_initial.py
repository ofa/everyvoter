    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vbm_application_deadline', models.DateField(null=True, blank=True, help_text=b'the date by which voters must return their applications applying to vote by mail', verbose_name=b'Vote By Mail Application Deadline')),
                ('vbm_return_date', models.DateField(null=True, blank=True, help_text=b'The date by which voters must return their mailed ballots', verbose_name=b'Vote By Mail Ballot Return Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('early_vote_by_county', models.BooleanField(help_text=b'Whether the availability or dates of early votes is county-by-county')),
