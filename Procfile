...
beat: REMAP_SIGTERM=SIGQUIT bin/start-pgbouncer newrelic-admin run-program celery -A everyvoter worker -Q default,feedback,high_memory -B --scheduler django_celery_beat.schedulers:DatabaseScheduler --without-heartbeat --concurrency 4
